...
| MinIO schema CI fast path (`--docs 10000`) | [x] | `./scripts/run-minio-large-schema-example.sh --docs 10000` → `*-schema-minio-10k.example.json` (not committed; same JSON keys as 100k example) |
