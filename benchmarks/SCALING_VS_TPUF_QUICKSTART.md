...
```bash
# 1. Regenerate all op-scaling JSON (10k / 50k / 100k cold + 10k warm + synthetic-128)
...
- Per-tier instead of `make bench-op-scaling`: `./scripts/run-op-scaling-benchmark.sh 10k|50k|100k|warm`.